      ...
      <div class="content" style=" position:relative; float: left; min-width: 50%;">        
        ...
        <div class="uploader" style=" position:absolute;">
          <div class = "wrapper" style="position:relative;float: left; min-width: 50%;">
            <form class="dropzone" action = "{{ route('plagiarismreports.store') }}" method="POST" enctype="multipart/form-data">
{{--               <input type="hidden" name="_method" value="PUT"> --}}
      ...
      <div class="content" style="position:relative; float: left; min-width: 50%;">
        ...
        <?php
          echo '<iframe src= "/'.$fyppart->id.'plagiarismreport.pdf", width="100%" style="height:80vh"></iframe>';   
        ?>
        </div>
      </div>
    </div>
